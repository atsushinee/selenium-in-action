...
public class Weibo {
    ...
    public void setCommentProvider(IWeiboComment weiboComment) {
...
//                        }
    ...
    public void runFollow() {
        driver.sleep(2);
        List<WebElement> hotDiv = driver.xs("//*[@class=\"WB_feed_detail clearfix\"]");
        System.out.println(hotDiv.size());
        for (int i = 1; i <= hotDiv.size(); i++) {
            System.out.printf("=================================第 %d 条=======================================\n", i);
...
//                        }
                ...
                driver.x("//*[@id=\"v6_pl_content_homefeed\"]/div/div[4]/div[%d]/div[3]/div/div/div[2]/div[2]/div[1]/textarea", i)
                        .sendKeys(reply);
                driver.x("//*[@id=\"v6_pl_content_homefeed\"]/div/div[4]/div[%d]/div[3]/div/div/div[2]/div[2]/div[2]/div[1]/a", i).click();
                driver.sleep(1);
                final WebElement layer = driver.x("//*[@class=\"W_layer \"]");
                if (layer != null) {
                    System.err.println("评论失败:" + driver.x("//*[@class=\"W_layer \"]/div[2]/div[3]/div/dl/dd/div").getText());
